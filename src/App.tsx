          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-500 text-white px-6 py-2 rounded-full font-semibold hover:from-purple-700 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                Faire un don
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t shadow-lg">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button
                  onClick={() => setShowDonationForm(true)}
                  className="block w-full text-left px-3 py-2 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-pink-600 transition-all duration-300 mt-2"
                >
                  Faire un don
                </button>
              </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 text-white pt-16">
          ...
          <p className="text-xl sm:text-2xl mb-8 font-light opacity-90 max-w-3xl mx-auto">
            Former une génération de jeunes filles éduquées, autonomes et
            leaders
          </p>
          <button
            onClick={() => scrollToSection("mission")}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Dans de nombreux pays africains, les jeunes filles abandonnent
                  fréquemment l'école et l'université à cause de{" "}
                  <span className="font-semibold text-purple-600">
                    contraintes financières
                  </span>
                  , de mariages ou grossesses précoces, du manque de mentors, et
                ...
                <p>
                  ...
                  Assurer un suivi continu des filles depuis le collège jusqu'à
                  leur premier emploi à travers le mentorat, le soutien
                  académique, financier et professionnel.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Nos Objectifs et Stratégies
            </h2>
            <div className="w-24 h-1 bg-purple-600 mx-auto mb-8"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Une approche holistique pour accompagner les jeunes filles à
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Suivi Scolaire et Orientation
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Tutorats personnalisés, clubs d'études, et ateliers
                d'orientation pour maintenir l'engagement scolaire et guider les
                choix académiques.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Réseau de Mentors Féminins
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Attribution de mentors expérimentés, sessions de coaching
                individuel et conférences inspirantes avec des femmes leaders.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Bourses d'études, fourniture d'ordinateurs portables, et aide au
                logement pour éliminer les barrières financières.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Développement des soft skills, formations au leadership et
                compétences numériques pour préparer au monde professionnel.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group md:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                Partenariats avec les entreprises, stages professionnels et
                forums de l'emploi pour faciliter l'accès au premier emploi.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="impact" className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-purple-600 mx-auto mb-8"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Des résultats mesurables pour transformer des vies et construire
              l'avenir
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl">
              ...
              <p className="text-lg font-medium text-gray-700 mb-2">
                Maintien jusqu'au Bac
              </p>
              <p className="text-gray-600">
                Des bénéficiaires maintenues à l'école jusqu'au baccalauréat
              </p>
            </div>
            ...
            <div className="text-center bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl">
              ...
              <p className="text-lg font-medium text-gray-700 mb-2">
                Diplômées Universitaires
              </p>
              <p className="text-gray-600">
                Des étudiantes obtiennent leur diplôme universitaire
              </p>
            </div>
            ...
            <div className="text-center bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">
                Décrochent un emploi dans les 12 mois suivant leur diplôme
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-8 rounded-2xl max-w-2xl mx-auto">
              ...
              <p className="text-lg text-gray-700">
                Création d'un réseau durable de femmes leaders qui continue
                d'inspirer et d'accompagner les générations futures
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="beneficiaires" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-purple-600 mx-auto mb-8"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Un accompagnement sur mesure pour chaque étape du parcours
            ...
            {[
              {
                title: "Collégiennes",
                description:
                  "Jeunes filles du collège (6e - 3e) pour un accompagnement précoce",
              ...
              },
              {
                title: "Lycéennes",
                description:
                  "Élèves du lycée (2nde - Terminale) préparant leur orientation",
              ...
              },
              {
                title: "Étudiantes",
                description:
                  "Étudiantes universitaires poursuivant leurs études supérieures",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl text-center group hover:from-purple-100 hover:to-pink-100 transition-all duration-300">
              ...
              <p className="text-gray-600">
                Plan International, UNICEF, ONU Femmes
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl text-center group hover:from-blue-100 hover:to-indigo-100 transition-all duration-300">
              ...
              <p className="text-gray-600">
                Banques, télécoms, et entreprises engagées dans la RSE
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl text-center group hover:from-green-100 hover:to-emerald-100 transition-all duration-300">
              ...
              <p className="text-gray-600">
                Ministères de l'Éducation et universités partenaires
              </p>
            </div>
          </div>
            ...
            <div className="absolute inset-0 bg-black/50 rounded-2xl flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <p className="text-lg opacity-90">
                  Ensemble, transformons l'avenir de l'éducation féminine
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                Plateforme d'accompagnement, de mentorat et de suivi des jeunes
                filles leaders. Ensemble, construisons l'avenir de l'éducation
                féminine en Afrique.
              </p>
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            <p className="text-gray-300">
              © 2025 Laalim Platform. Tous droits réservés. | Projet Hackathon -
              Accompagnement Jeunes Filles Leaders
            </p>
          </div>
        </div>
      </footer>
